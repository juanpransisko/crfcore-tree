"""
Binary transition feature function for CRF sequence labeling.

Each FeatureFunction instance represents a single indicator function
f(y_{t-1}, y_t) that fires when the previous and current labels
match a specific bigram pattern.
"""
